  ...
  const courses = [
    {
      ...
      plans: [
        { days: 2, price: 32, classes: 8, hours: 4, popular: true },
        { days: 3, price: 45, classes: 12, hours: 6, popular: false },
        { days: 5, price: 70, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 2,
      ...
      plans: [
        { days: 2, price: 38, classes: 8, hours: 4, popular: true },
        { days: 3, price: 54, classes: 12, hours: 6, popular: false },
        { days: 5, price: 82, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 3,
      ...
      plans: [
        { days: 2, price: 48, classes: 8, hours: 4, popular: true },
        { days: 3, price: 68, classes: 12, hours: 6, popular: false },
        { days: 5, price: 102, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 4,
      ...
      plans: [
        { days: 2, price: 43, classes: 8, hours: 4, popular: true },
        { days: 3, price: 60, classes: 12, hours: 6, popular: false },
        { days: 5, price: 88, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 5, 
      ...
      plans: [
        { days: 2, price: 52, classes: 8, hours: 4, popular: true },
        { days: 3, price: 72, classes: 12, hours: 6, popular: false },
        { days: 5, price: 108, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 6,
      ...
      plans: [
        { days: 2, price: 60, classes: 8, hours: 4, popular: true },
        { days: 3, price: 84, classes: 12, hours: 6, popular: false },
        { days: 5, price: 125, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      id: 7,
      ...
      plans: [
        { days: 2, price: 35, classes: 8, hours: 4, popular: true },
        { days: 3, price: 48, classes: 12, hours: 6, popular: false },
        { days: 5, price: 70, classes: 20, hours: 10, popular: false }
      ]
    },
    {
      ...
      plans: [
        { days: 2, price: 55, classes: 8, hours: 4, popular: true },
        { days: 3, price: 76, classes: 12, hours: 6, popular: false },
        { days: 5, price: 112, classes: 20, hours: 10, popular: false }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto">
              Affordable Quran learning with certified teachers. Choose from 8 specialized courses.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 -mt-16">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-center">Select Your Course</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {courses.map((course, index) => (
              ...
              >
                ...
                <div className="text-xs text-gray-600 mt-1">{course.level}</div>
              </button>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-green-600 text-white rounded-2xl p-6 mb-8"
        >
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              <Zap className="w-6 h-6 mb-2" />
              <div className="font-bold text-sm md:text-base">Best Value Plans</div>
              <div className="text-green-100 text-xs">Most popular options highlighted</div>
            </div>
            <div className="flex flex-col items-center">
              <Clock className="w-6 h-6 mb-2" />
              <div className="font-bold text-sm md:text-base">2 Free Trial Classes</div>
              <div className="text-green-100 text-xs">Experience before enrollment</div>
            </div>
            <div className="flex flex-col items-center">
              <Users className="w-6 h-6 mb-2" />
              <div className="font-bold text-sm md:text-base">1-on-1 Classes</div>
              <div className="text-green-100 text-xs">Personalized attention</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-6 text-white">
            <h2 className="text-2xl md:text-3xl font-bold mb-2">{currentCourse.name}</h2>
            <p className="opacity-90 text-sm md:text-base">{currentCourse.description}</p>
          </div>
                ...
                >
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold">{plan.hours} hours</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Per class:</span>
                      <span className="font-semibold">
                        {getCurrencySymbol()}
                        {convertPrice(plan.price / plan.classes).toFixed(0)}
                      </span>
                    </div>
                  </div>
