...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Main Content with Semantic HTML - SWAPPED ORDER */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
        ...
        <article className="bg-white shadow-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 order-1">
        ...
        <aside className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 order-2">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-gray-800 text-center sm:text-left">
            Contact Information
          </h2>
  ...
  ></iframe>
          ...
          <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-white rounded-lg border border-green-200">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              ...
              with flexible schedules and free trial classes.
            </p>
          </div>
        </aside>
      </section>
