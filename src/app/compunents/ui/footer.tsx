    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 py-12 px-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm">
            Learn Quran with qualified teachers from comfort of your home.
          </p>
        </div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex gap-3 pt-2">
              {[Facebook, Twitter, Linkedin].map((Icon, index) => (
                <Icon key={index} size={18} className="hover:text-blue-600 transition cursor-pointer" />
              ))}
              {[ Instagram].map((Icon, index) => (
                <Icon key={index} size={18} className="hover:text-pink-600 transition cursor-pointer" />
              ))}
            </div>
          </div>
        </div>
